...
Kept the game looking the same whenever possible.
Changes made were mostly for gameplay clarity reasons.

Used transparency a lot to help gameplay elements blend better with the background.
...
Skin elements only for osu standard.
...
* Scores:
  * Score numbers are about half the default size, and less colourful to not distract from gameplay elements.
  * 300x is disabled. If you would like to see it, there is a 300x file in the folder, but you'll have to scale it down to the right resolution.
* Got rid of most particle effects.
